        ...
        <div className="flex min-h-[calc(100vh-80px)] items-center justify-center bg-white px-4">
            <div className="w-full max-w-[450px]">
                <div className="mb-10 flex justify-between items-start">
                    <div>
                        <h1 className="text-[32px] font-black tracking-tight text-secondary">Sign Up</h1>
                ...
                {error && <div className="mb-6 rounded-lg bg-red-50 p-4 font-bold text-red-500 border-l-4 border-red-500 text-sm">{error}</div>}

                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="relative border-b-2 border-gray-100 focus-within:border-primary transition-all pb-1 group">
                        <label className="block text-[11px] font-black text-gray-400 uppercase tracking-widest pl-4 group-focus-within:text-primary transition">Full Name</label>
                        <input
                            type="text"
                    ...
                    <div className="relative border-b-2 border-gray-100 focus-within:border-primary transition-all pb-1 group">
                        <label className="block text-[11px] font-black text-gray-400 uppercase tracking-widest pl-4 group-focus-within:text-primary transition">Confirm Password</label>
                        <input
                            type="password"
                            className="w-full bg-transparent px-4 py-3 outline-none font-bold text-lg text-secondary placeholder:text-gray-200"
                            placeholder="••••••••"
                ...
                <p className="mt-8 text-center text-[12px] font-bold text-gray-400">
                    By clicking on Continue, I accept the <span className="text-secondary hover:underline cursor-pointer">Terms & Conditions</span> & <span className="text-secondary hover:underline cursor-pointer">Privacy Policy</span>
                </p>
            </div>
        </div>
    );
